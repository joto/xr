...
#  xr2.rb
#
#  experimental renderer no. 2
#
#  ... which first creates objects containing rendering instructions, then
#  sorts those objects and then does the actual rendering.
#
#-----------------------------------------------------------------------------
...
map.add(XR::Symbolizer::LineWithCasing.new).
        data(roads).
        order{ |attr|
            [ attr['layer'].to_i, road_prio_lookup[attr['type']].to_i ]
        }.
        core_color{ |attr|
